...
---@param data number The value to write to the bit: 0 (low) Non‑zero (high) 
...
--- ```
---@return number row The row where the cursor is: 1 (top row); 2 (bottom row) 
---@return number column The column where the cursor is: If the cursor is in the top row: 1 to 20 If the cursor is in the bottom row: 1 to 32 
---@return number style Visibility of the cursor: Invisible: 0 Blinking: 1 
...
---@param embellished boolean Indicates type of returned text: false (simple text); true (text with embedded character codes) 
---@param row number Selects the row from which to read the text: 1 (row 1); 2 (row 2). If row is not included, both rows of text are read 
...
---@param memory display Determines if code is saved to nonvolatile memory: 0 or display.DONT_SAVE: Does not save the code to nonvolatile memory 1 or display.SAVE: Saves the code to nonvolatile memory (default) 
...
--- ```
---@param text string Text message to be displayed, with optional character codes 
...
--- ```
---@return boolean triggered true: Trigger was detected false: The operation timed out 
---@param timeout number Timeout in seconds 
...
--- ```
---@param system boolean What to reset: true: If the node is the master, the entire system is reset (default) false: Only the local group is reset 
---@overload fun()
...
---@param formatType string A string indicating which file type to use: csv or xml 
...
--- ```
---@param id number|string An integer or string that specifies the location of the setup to recall: Factory default setup: 0 User-saved setup in nonvolatile memory: 1 to 5 User-saved setup on a USB flash drive: "/path/filename" 
...
--- ```
---@param id number|string An integer or string specifying where to save the user setup: Save in nonvolatile memory (1 to 5) Save as user-saved setup on a USB flash drive ("/path/filename") 
...
---@overload fun()
---@overload fun()
---@overload fun(readingBuffer)
---@overload fun(iReadingBuffer)
...
--- ```
---@return boolean triggered true: A trigger was detected during the timeout period false: No triggers were detected during the timeout period 
...
---@param data number The value to write to the bit: Low: 0 High: 1 
...
--- ```
---@return string connectionID The connection ID to be used as a handle in all other tspnet function calls 

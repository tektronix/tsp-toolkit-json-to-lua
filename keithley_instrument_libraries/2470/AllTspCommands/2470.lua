...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/13987.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/13988.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- for name in userstring.catalog() do
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/13989.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/13990.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- userstring.add("assetnumber", "236")
...
--- **This function returns to a previous version of the Model 2470 firmware.**
---
--- *Type:*  Function
---
--- *Details:*<br>
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/14062.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- ```
...
--- **This function upgrades the Model 2470 firmware.**
---
--- *Type:*  Function
---
--- *Details:*<br>
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/14063.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- ```
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/14073.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/14074.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/14076.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- This function retrieves the response of the remote device to *IDN?.
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/14078.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/14079.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/14080.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/14081.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- ```
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/14084.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- tspnet.timeout = 2.0
...
---
--- *Details:*<br>
--- The tspnet.write() function sends inputString to the remote instrument. It does not wait for command completion on the remote instrument.The Model 2470 sends inputString to the remote instrument exactly as indicated. The inputString must contain any necessary new lines, termination, or other syntax elements needed to complete properly.Because tspnet.write() does not process output from the remote instrument, do not send commands that generate too much output without processing the output. This command can stop executing if there is too much unprocessed output from previous commands.
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/14089.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/34363.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- deviceID = tspnet.connect("192.0.2.1")
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/14654.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dataqueue.clear()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/14655.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/14656.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- MaxCount = dataqueue.CAPACITY
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/14657.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- MaxCount = dataqueue.CAPACITY
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/14658.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dataqueue.clear()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/14808.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/14810.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- if fs.is_dir("/usb1/temp") == true then
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/14811.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/14812.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- if fs.is_dir("/usb1/temp") == false then
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/14814.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- rootDirectory = "/usb1/"
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/14815.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- rootDirectory = "/usb1/"
...
--- The file system path may be absolute or relative to the current working system path.
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/14824.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- rootDirectory = "/usb1/"
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/14860.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- gpib.address = 26
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/14893.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- print(lan.lxidomain)
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25725.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---@overload fun(method:lanipconfigmethod):method:lanipconfigmethod, ipV4Address:string, subnetMask:string, gateway:string
---@overload fun(method:lanipconfigmethod,ipV4Address:string):method:lanipconfigmethod, ipV4Address:string, subnetMask:string, gateway:string
---@overload fun(method:lanipconfigmethod,ipV4Address:string,subnetMask:string):method:lanipconfigmethod, ipV4Address:string, subnetMask:string, gateway:string
---@overload fun(method:lanipconfigmethod,ipV4Address:string,subnetMask:string,gateway:string):method:lanipconfigmethod, ipV4Address:string, subnetMask:string, gateway:string
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/28423.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/15009.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/15010.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/15020.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/15013.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25726.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30504.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/32416.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- print(os.date('%c', gettime()))
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/32595.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/32597.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- display.clear()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/32628.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/33140.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/33148.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/34629.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/40235.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/15285.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- tsplink.group = 3
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/15287.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- tsplink.node = 3
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/15289.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/15291.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- state = tsplink.state
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/15302.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- tsplink.writeport(3)
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30551.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/32565.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25637.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- *TRG
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25639.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30574.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31093.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
--- *Details:*<br>
--- Digitized measurements are not a feature on the Model 2470. However, you can use this command to communicate with other Keithley instruments that do offer the digitized measurements feature and to share code with other Keithley instruments.Firmware versions of the Model 2470 before version 1.7.0 had a separate measure block. If you have code that is using that block, it works in this version of the Model 2470 firmware.
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31094.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31095.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31096.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31097.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31098.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31101.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31102.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31103.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31104.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31105.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31107.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31108.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31109.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31110.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31112.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31114.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31347.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/35428.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/35431.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/41689.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- trigger.model.load("Empty")
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/88463.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/16856.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- test8.run()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/16863.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- test8.save()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/33395.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- print(test7.source)
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25737.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30521.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.reset()
...
smu.BREAKDOWN_AUTO = nil
smu.BREAKDOWN_OFF = nil
smu.BREAKDOWN_ON = nil
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25624.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---@param bufferVar bufferVar The name of the reading buffer, which may be a default buffer (defbuffer1 or defbuffer2) or a user-defined buffer; if no buffer is specified, this parameter defaults to defbuffer1
...
---@overload fun():statsVar:statsVar
---@overload fun(bufferVar:bufferVar):statsVar:statsVar
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25629.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- ```
---@return bufferVar bufferVar The name of the buffer
---@param bufferSize integer The maximum number of readings that can be stored in bufferVar; minimum is 10; 0 to maximize buffer size (see Details)
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25642.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- ```
---@param bufferVar bufferVar Indicates the reading buffer to use; the default buffers (defbuffer1 or defbuffer2) or the name of a user-defined buffer; if no buffer is specified, defbuffer1 is used
...
---@param start integer Defines the starting point in the buffer to start saving data
---@param end integer Defines the ending point in the buffer to stop saving data
---@overload fun(bufferVar:bufferVar,fileName:string)
---@overload fun(bufferVar:bufferVar,fileName:string,timeFormat:buffersaveappendtimeFormat)
function buffer.saveappend(bufferVar, fileName, timeFormat, start, end) end
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/33981.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- ```
---@param bufferName bufferVar The name of a user-defined reading buffer
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/34560.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- buffer.clearstats()
...
--- ```
---@param bufferVar bufferVar The name of the reading buffer, which may be a default buffer (defbuffer1 or defbuffer2) or a user-defined buffer; defaults to defbuffer1 if not specified
---@overload fun()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/76401.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
--- *Details:*<br>
--- The file name must specify the full path (including /usb1/). If included, the file extension must be set to .csv. If no file extension is specified, .csv is added.Examples of valid destination file names:The Model 2470 does not check for existing files when you save. Verify that you are using a unique name to avoid overwriting any existing CSV files on the flash drive.
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/85101.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- ```
---@param bufferVar bufferVar The name of the reading buffer, which may be a default buffer (defbuffer1 or defbuffer2) or a user-defined buffer
---@param fileName string A string that indicates the name of the file on the USB flash drive in which to save the reading buffer
...
---@param end integer Defines the ending point in the buffer to stop saving data
---@overload fun(bufferVar:bufferVar,fileName:string)
---@overload fun(bufferVar:bufferVar,fileName:string,timeFormat:buffersavetimeFormat)
function buffer.save(bufferVar, fileName, timeFormat, start, end) end
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25630.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset() 
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25640.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
--- This attribute contains the unit of measure that is stored with readings in the reading buffer.
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25641.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset() 
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25706.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset() 
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25707.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset() 
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25712.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25713.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset() 
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25715.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset() 
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25716.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset() 
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30485.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30488.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30489.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30538.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30542.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30545.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset() 
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30550.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset() 
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30577.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset() 
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/33164.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset() 
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/34340.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset() 
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/46323.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/56793.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/56794.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- test1 = buffer.make(100)
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/81089.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/81090.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- extBuffer = buffer.make(100, buffer.STYLE_WRITABLE_FULL)
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25635.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dataqueue.clear()
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25636.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dataqueue.clear()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25702.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/27637.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- ```
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/27658.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- ```
---@return integer eventNumber The event number
---@return string message A description of the event
---@return integer severity The severity of the event
---@return integer nodeID The TSP-Link node where the event occurred or 0 if the event occurred on the local node
---@return integer timeSeconds The seconds portion of the time when the event occurred
---@return integer timeNanoSeconds The fractional seconds portion of the time when the event occurred
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30552.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/34730.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- eventlog.clear()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25719.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---@alias displaysettextdisplayArea
---|`display.TEXT1`
---|`display.TEXT2`
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25722.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- display.clear()
...
--- --
--- ```
---@param displayArea displaysettextdisplayArea display.TEXT1 display.TEXT2
---@param text string String that contains the message for the top line of the USER swipe screen (up to 20 characters)
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30502.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- display.clear()
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30503.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- display.clear()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/33260.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- ```
---@return promptID promptID A set of characters that identifies the prompt; up to 63 characters
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/33261.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.source.sweeplinear("test", 1, 10, 10)
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/33459.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/38977.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- --
--- ```
---@param promptID promptID The identifier defined by display.prompt()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/81840.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25723.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- file.mkdir("TestData")
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25724.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/27929.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- --Close the file.
--- ```
---@return string | nil fileContents The contents of the file based on the readAction parameter
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/27930.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/27934.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/27958.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/34905.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- local response
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/28048.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- x = 1.23
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/28056.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/28063.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- format.asciiprecision = 10
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30567.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- status.clear()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31635.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/32386.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/33635.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- status.preset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30981.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- digio.writeport(63)
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31368.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- data = digio.readport()
...
--- ```
---@return integer data The present value of the input lines on the digital I/O port
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/33286.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---@return scriptVar scriptVar The created script; a global variable with this name is used to reference the script
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/33290.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/33394.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- script.delete("test8")
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/14085.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/14086.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/14090.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---@param startIndex integer Integer start value
---@param endIndex integer Integer end value
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/32684.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/15785.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/15787.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/15788.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/17666.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/34428.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/35118.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- digio.line[3].mode = digio.MODE_TRIGGER_IN
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/15793.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/15794.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/15795.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/15800.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/15820.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30576.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
triggertimerArr.enable = trigger.OFF
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31076.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25622.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.measure.func = smu.FUNC_DC_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25688.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---@param bufferName bufferVar The name of the reading buffer, which may be a default buffer (defbuffer1 or defbuffer2) or a user-defined buffer; if no buffer is defined, it defaults to defbuffer1
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25730.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.measure.func = smu.FUNC_RESISTANCE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/28416.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.measure.func = smu.FUNC_DC_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/29064.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.measure.func = smu.FUNC_DC_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/29137.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.measure.func = smu.FUNC_RESISTANCE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/29393.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.measure.func = smu.FUNC_DC_CURRENT
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/29407.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.source.func = smu.FUNC_DC_CURRENT
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/29423.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.measure.func = smu.FUNC_DC_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/29432.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.measure.func = smu.FUNC_DC_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30505.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30560.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.measure.func = smu.FUNC_DC_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31441.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.measure.userdelay[1] = 5
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31457.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---@overload fun(bufferName:bufferVar):reading:number, seconds:number, fractional:number
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/88860.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.measure.func = smu.FUNC_DC_CURRENT
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/91266.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---@param function smumeasuregetattributefunction The measurement function
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/91445.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- ```
---@param function smumeasuresetattributefunction The measurement function
...
function smu.measure.setattribute(function, setting, value) end
---@class trigger.model
trigger.model = {}
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25628.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- trigger.model.abort()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25741.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---@return triggermodelstatestatus status The status of the parallel/dual trigger model
---@return integer n The last trigger model block that was executed
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30569.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- print(trigger.model.getblocklist())
...
--- ```
---@return string output Returns the settings for the trigger model
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30570.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30571.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- ```
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/72471.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/73512.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/28022.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.source.output = smu.ON
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/29079.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.source.func = smu.FUNC_DC_VOLTAGE
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/29238.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/29382.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.source.func = smu.FUNC_DC_CURRENT
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/29383.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.source.func = smu.FUNC_DC_CURRENT
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/29386.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.source.func = smu.FUNC_DC_CURRENT
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/29907.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.source.func = smu.FUNC_DC_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30563.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---@param points integer The number of source-measure points between the start and stop values of the sweep (2 to 1e6); to calculate the number of source-measure points in a sweep, use the following formula
---@param sDelay smusourcesweeplinearsDelay | number The delay between measurement points; default is smu.DELAY_AUTO, which enables autodelay, or a specific delay value from 50 µs to 10 ks, or 0 for no delay
---@param count smusourcesweeplinearcount | integer The number of times to run the sweep; default is 1
...
---@param bufferName bufferVar The name of a reading buffer; the default buffers (defbuffer1 or defbuffer2) or the name of a user-defined buffer; if no buffer is specified, this parameter defaults to defbuffer1
---@overload fun(configListName:string,start:number,stop:number,points:integer)
---@overload fun(configListName:string,start:number,stop:number,points:integer,sDelay:smusourcesweeplinearsDelay | number)
---@overload fun(configListName:string,start:number,stop:number,points:integer,sDelay:smusourcesweeplinearsDelay | number,count:smusourcesweeplinearcount | integer)
---@overload fun(configListName:string,start:number,stop:number,points:integer,sDelay:smusourcesweeplinearsDelay | number,count:smusourcesweeplinearcount | integer,rangeType:smusourcesweeplinearrangeType)
---@overload fun(configListName:string,start:number,stop:number,points:integer,sDelay:smusourcesweeplinearsDelay | number,count:smusourcesweeplinearcount | integer,rangeType:smusourcesweeplinearrangeType,failAbort:smusourcesweeplinearfailAbort)
---@overload fun(configListName:string,start:number,stop:number,points:integer,sDelay:smusourcesweeplinearsDelay | number,count:smusourcesweeplinearcount | integer,rangeType:smusourcesweeplinearrangeType,failAbort:smusourcesweeplinearfailAbort,dual:smusourcesweeplineardual)
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30565.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---@param sDelay smusourcesweeplinearstepsDelay | number The delay between measurement points; default is smu.DELAY_AUTO, which enables autodelay, a specific delay value from 50 μs to 10 ks, or 0 for no delay
---@param count smusourcesweeplinearstepcount | integer The number of times to run the sweep; default is 1
...
---@overload fun(configListName:string,start:number,stop:number,step:number,sDelay:smusourcesweeplinearstepsDelay | number)
---@overload fun(configListName:string,start:number,stop:number,step:number,sDelay:smusourcesweeplinearstepsDelay | number,count:smusourcesweeplinearstepcount | integer)
---@overload fun(configListName:string,start:number,stop:number,step:number,sDelay:smusourcesweeplinearstepsDelay | number,count:smusourcesweeplinearstepcount | integer,rangeType:smusourcesweeplinearsteprangeType)
---@overload fun(configListName:string,start:number,stop:number,step:number,sDelay:smusourcesweeplinearstepsDelay | number,count:smusourcesweeplinearstepcount | integer,rangeType:smusourcesweeplinearsteprangeType,failAbort:smusourcesweeplinearstepfailAbort)
---@overload fun(configListName:string,start:number,stop:number,step:number,sDelay:smusourcesweeplinearstepsDelay | number,count:smusourcesweeplinearstepcount | integer,rangeType:smusourcesweeplinearsteprangeType,failAbort:smusourcesweeplinearstepfailAbort,dual:smusourcesweeplinearstepdual)
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30566.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---@param stop number The voltage or current at which the sweep stops
---@param points integer The number of source-measure points between the start and stop values of the sweep (2 to 1e6); to calculate the number of source-measure points in a sweep, use the following formula
---@param sDelay smusourcesweeplogsDelay | number The delay between measurement points; default is smu.DELAY_AUTO, which enables autodelay, or a specific delay value from 50 μs to 10 ks, or 0 for no delay
---@param count smusourcesweeplogcount | integer The number of times to run the sweep; default is 1
...
---@overload fun(configListName:string,start:number,stop:number,points:integer)
---@overload fun(configListName:string,start:number,stop:number,points:integer,sDelay:smusourcesweeplogsDelay | number)
---@overload fun(configListName:string,start:number,stop:number,points:integer,sDelay:smusourcesweeplogsDelay | number,count:smusourcesweeplogcount | integer)
---@overload fun(configListName:string,start:number,stop:number,points:integer,sDelay:smusourcesweeplogsDelay | number,count:smusourcesweeplogcount | integer,rangeType:smusourcesweeplograngeType)
---@overload fun(configListName:string,start:number,stop:number,points:integer,sDelay:smusourcesweeplogsDelay | number,count:smusourcesweeplogcount | integer,rangeType:smusourcesweeplograngeType,failAbort:smusourcesweeplogfailAbort)
---@overload fun(configListName:string,start:number,stop:number,points:integer,sDelay:smusourcesweeplogsDelay | number,count:smusourcesweeplogcount | integer,rangeType:smusourcesweeplograngeType,failAbort:smusourcesweeplogfailAbort,dual:smusourcesweeplogdual)
---@overload fun(configListName:string,start:number,stop:number,points:integer,sDelay:smusourcesweeplogsDelay | number,count:smusourcesweeplogcount | integer,rangeType:smusourcesweeplograngeType,failAbort:smusourcesweeplogfailAbort,dual:smusourcesweeplogdual,bufferName:bufferVar)
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30579.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30580.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31499.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---@param index integer The index in the configuration list where the sweep starts; default is 1
...
---@param count smusourcesweeplistcount | integer The number of times to run the sweep; default is 1
...
---@overload fun(configListName:string,index:integer)
---@overload fun(configListName:string,index:integer,sDelay:number)
---@overload fun(configListName:string,index:integer,sDelay:number,count:smusourcesweeplistcount | integer)
---@overload fun(configListName:string,index:integer,sDelay:number,count:smusourcesweeplistcount | integer,failAbort:smusourcesweeplistfailAbort)
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/33143.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- To use this command in a trigger model, assign the delay to the dynamic delay block.The delay is specific to the selected function.
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/34973.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/91275.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- ```
---@param function smusourcesetattributefunction The source function; set to one of the following values
...
--- You can retrieve one attribute at a time.
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/91276.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- ```
---@return any value The attribute value
---@param function smusourcegetattributefunction The source function
...
function smu.source.getattribute(function, setting) end
---@class smu.interlock
smu.interlock = {}
...
---
--- *Details:*<br>
--- This command gives you the status of the interlock. When the safety interlock signal is asserted, all voltage ranges of the instrument are available. However, when the safety interlock signal is not asserted, the 200 V and 1000 V ranges are hardware limited to a nominal output of less than ±42 V.When the interlock is not asserted:
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25729.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/88873.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/28111.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31397.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31398.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31413.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30501.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- ```
---@type triggerEvents
triggerdigoutArr.stimulus= trigger.EVENT_NONE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31385.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31392.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- digio.line[2].mode = digio.MODE_TRIGGER_OUT
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31395.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- digio.line[4].mode = digio.MODE_TRIGGER_OUT
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/33159.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- digio.line[4].mode = digio.MODE_TRIGGER_OUT
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30523.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- --4918    4917
--- ```
---@return integer setEvent The event mapped to set this bit; 0 if no mapping
---@return integer clearEvent The event mapped to clear this bit; 0 if no mapping
---@param bitNumber integer The bit number to check
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31637.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31638.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31639.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31648.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- ```
---@param bitNumber integer The bit number that is mapped to an event (0 to 14)
---@param setEvent integer The number of the event that sets the bits in the condition and event registers; 0 if no mapping
---@param clearEvent integer The number of the event that clears the bit in the condition register; 0 if no mapping
---@overload fun(bitNumber:integer,setEvent:integer)
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30524.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- You can map events to bits in the event registers with this command. This allows you to cause bits in the condition and event registers to be set or cleared when the specified events occur. You can use any valid event number as the event that sets or clears bits.When a mapped event is programmed to set bits, the corresponding bits in both the condition register and event register are set when the event is detected.When a mapped event is programmed to clear bits, the bit in the condition register is set to 0 when the event is detected.If the event is set to zero (0), the bit is never set.See Event numbers for information about event numbers.
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31612.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- When you query the mapping for a specific bit, the instrument returns the events that were mapped to set and clear that bit. Zero (0) indicates that the bits have not been set.
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31613.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---@return integer setEvent The event mapped to set this bit; 0 if no mapping
---@return integer clearEvent The event mapped to clear this bit; 0 if no mapping
---@param bitNumber integer The bit number to check (0 to 14)
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31614.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31615.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30525.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31653.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30982.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31363.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31393.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31360.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31373.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31378.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31394.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- digio.line[4].mode = digio.MODE_TRIGGER_IN
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31396.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31401.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31404.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- ```
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31406.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- trigger.lanout[1].protocol = lan.PROTOCOL_MULTICAST
...
--- ```
---@type boolean
triggerlanoutArr.connected = true
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31409.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31416.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
triggerlanoutArr.protocol = lan.PROTOCOL_TCP
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/31419.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/33157.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/32538.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/32541.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/32542.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
tsplinklineArr.state = tsplink.STATE_LOW
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/32539.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- tsplink.line[3].mode = tsplink.MODE_TRIGGER_OPEN_DRAIN
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/32551.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- This command indicates whether an event has been ignored because the event detector was already in the detected state when the event occurred.This is an indication of the state of the event detector built into the synchronization line itself.It does not indicate if an overrun occurred in any other part of the trigger model, or in any other construct that is monitoring the event. It also is not an indication of an output trigger overrun.
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/32552.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- ```
---@type boolean
triggertsplinkinArr.overrun = true
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/32561.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- tsplink.line[3].mode = tsplink.MODE_TRIGGER_OPEN_DRAIN
...
--- This attribute controls the logic that the output trigger generator uses on the given trigger line.The output state of the digital I/O line is controlled by the trigger logic, and the user-specified output state of the line is ignored.
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/32540.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- tsplink.line[3].mode = tsplink.MODE_TRIGGER_OPEN_DRAIN
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/32549.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- tsplink.line[2].mode = tsplink.MODE_TRIGGER_OPEN_DRAIN
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/32553.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- tsplink.line[3].mode = tsplink.MODE_TRIGGER_OPEN_DRAIN
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/32555.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- tsplink.line[3].mode = tsplink.MODE_TRIGGER_OPEN_DRAIN
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/32558.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- ```
---@type triggerEvents
triggertsplinkoutArr.stimulus= trigger.EVENT_NONE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/40051.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.source.func = smu.FUNC_DC_CURRENT
...
---@overload fun(dialogTitle:string):numberEntered:number
---@overload fun(dialogTitle:string,numberFormat:displayinputnumbernumberFormat):numberEntered:number
---@overload fun(dialogTitle:string,numberFormat:displayinputnumbernumberFormat,defaultValue:number):numberEntered:number
---@overload fun(dialogTitle:string,numberFormat:displayinputnumbernumberFormat,defaultValue:number,minimumValue:number):numberEntered:number
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/40052.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/40053.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/40054.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---@overload fun(dialogTitle:string):textEntered:string|nil
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/46427.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- --1, Watt DC, 7, Watt DC, 2, Watt DC, 8, Watt DC, 3, Watt DC, 9, Watt DC, 4, Watt DC, 10, Watt DC, 5, Watt DC, 11, Watt DC, 6, Watt DC, 12, Watt DC
--- ```
---@param bufferVar bufferVar The name of the buffer
...
---@overload fun(bufferVar:bufferVar,units:bufferwriteformatunits,displayDigits:bufferwriteformatdisplayDigits)
---@overload fun(bufferVar:bufferVar,units:bufferwriteformatunits,displayDigits:bufferwriteformatdisplayDigits,extraUnits:bufferwriteformatunits)
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/46428.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- extBuffer = buffer.make(100, buffer.STYLE_WRITABLE)
...
--- ```
---@param bufferVar bufferVar The name of the buffer
---@param readingValue integer The first value that is recorded in the buffer index
---@param extraValue integer A second value that is recorded in the buffer index (only valid for buffer style WRITABLE_FULL)
...
---@overload fun(bufferVar:bufferVar,readingValue:integer)
---@overload fun(bufferVar:bufferVar,readingValue:integer,seconds:number)
---@overload fun(bufferVar:bufferVar,readingValue:integer,extraValue:integer)
---@overload fun(bufferVar:bufferVar,readingValue:integer,extraValue:integer,seconds:number)
---@overload fun(bufferVar:bufferVar,readingValue:integer,seconds:number,fractionalSeconds:number)
---@overload fun(bufferVar:bufferVar,readingValue:integer,seconds:number,fractionalSeconds:number,status:readingStatus)
---@overload fun(bufferVar:bufferVar,readingValue:integer,extraValue:integer,seconds:number,fractionalSeconds:number)
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25644.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.measure.func = smu.FUNC_DC_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25687.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.measure.func = smu.FUNC_DC_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30109.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.measure.func = smu.FUNC_DC_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25645.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.measure.func = smu.FUNC_DC_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/29986.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.measure.func = smu.FUNC_DC_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/29987.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.measure.func = smu.FUNC_DC_CURRENT
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25682.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.measure.func = smu.FUNC_DC_CURRENT
...
smumeasurelimitArr.autoclear = smu.OFF
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25683.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.measure.func = smu.FUNC_DC_CURRENT
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25684.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
smumeasurelimitArr.fail = smu.FAIL_NONE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/29884.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.measure.func = smu.FUNC_DC_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/41684.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- state
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25691.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.measure.configlist.create("MyMeasList")
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/28417.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- ```
---@return string | nil output Returns the name of one measure configuration list that is stored on the instrument
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/28418.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/28419.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- ```
---@param listName string A string that represents the name of a measure configuration list
---@param index integer A number that defines a specific configuration index in the measure configuration list
---@param sourceListName string A string that represents the name of a source configuration list
---@param sourceIndex integer A number that defines a specific configuration index in the source configuration list
---@overload fun(listName:string)
---@overload fun(listName:string,index:integer)
---@overload fun(listName:string,index:integer,sourceListName:string)
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/28421.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30559.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/32926.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- --1
--- ```
---@return integer indexCount A number that represents the total count of indexes stored in the specified measure configuration list
---@param listName string A string that represents the name of a measure configuration list
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/91273.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.measure.configlist.create("MyMeasList")
...
---@param function smumeasureconfigliststorefuncfunction The measure function settings to save into the configuration list
---@param index integer The number of the configuration list index in which to store the settings
---@overload fun(listName:string,function:smumeasureconfigliststorefuncfunction)
function smu.measure.configlist.storefunc(listName, function, index) end
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25693.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25695.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25696.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset() 
...
--- Deletes a configuration list. If the index is not specified, the entire configuration list is deleted. If the index is specified, only the specified configuration index in the list is deleted.When an index is deleted from a configuration list, the index numbers of the following indexes are shifted up by one. For example, if you have a configuration list with 10 indexes and you delete index 3, the index that was numbered 4 becomes index 3, and the all the following indexes are renumbered in sequence to index 9. Because of this, if you want to delete several nonconsecutive indexes in a configuration list, it is best to delete the higher numbered index first, then the next lower index, and so on. This also means that if you want to delete all the indexes in a configuration list, you must delete index 1 repeatedly until all indexes have been removed.
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25697.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25698.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- ```
---@param listName string A string that represents the name of a source configuration list
---@param index integer A number that defines a specific configuration index in the configuration list; the default is the first index in the configuration list
---@param fieldSeparator string String that represents the separator for the data; use one of the following
---@overload fun(listName:string,index:integer)
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25700.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- print(smu.source.configlist.size("MyScrList"))
...
--- --2
--- ```
---@return integer indexCount A number that represents the total quantity of indexes stored in the specified source configuration list
---@param listName string A string that represents the name of a source configuration list
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/33155.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- ```
---@param listName string A string that represents the name of a source configuration list
---@param index integer A number that defines a specific configuration index in the source configuration list
---@param measureListName string A string that represents the name of a measure configuration list
---@param measureIndex integer A number that defines a specific configuration index in the measure configuration list
---@overload fun(listName:string)
---@overload fun(listName:string,index:integer)
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/91274.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---@param function smusourceconfigliststorefuncfunction The function to save into the configuration list
---@param index integer The number of the configuration list index in which to store the settings
---@overload fun(ConfigListName:string,function:smusourceconfigliststorefuncfunction)
function smu.source.configlist.storefunc(ConfigListName, function, index) end
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/29048.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.measure.func = smu.FUNC_DC_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/29049.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/29072.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.source.func = smu.FUNC_DC_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30235.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
smu.source.protect.tripped = smu.OFF
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30064.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.measure.func = smu.FUNC_DC_CURRENT
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30065.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.measure.func = smu.FUNC_DC_CURRENT
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30066.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.measure.func = smu.FUNC_DC_CURRENT
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30536.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- trigger.timer[4].reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30553.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30555.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- digio.line[3].mode = digio.MODE_TRIGGER_IN
...
--- ```
---@type triggerEvents
triggertimerArr.start.stimulus= trigger.EVENT_NONE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/33984.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- This command configures the alarm of the timer.When the timer is enabled, the timer starts immediately if the timer is configured for a start time that has passed.
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/33985.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30561.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.source.func = smu.FUNC_DC_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30562.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25685.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- highLimit
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/25686.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- lowLimit
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30107.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.measure.func = smu.FUNC_DC_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30108.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- smu.measure.func = smu.FUNC_DC_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/13949.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/13986.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- waitcomplete()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/14769.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- ```
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/15057.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---@param bufferVar bufferVar Name of first table or reading buffer subtable to print; may be a default buffer (defbuffer1 or defbuffer2) or a user-defined buffer
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/15058.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- format.asciiprecision = 10
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/17645.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- x = 10
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/29846.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- opc()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/34054.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset(true)
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/34589.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/89066.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---@param functionality functionality The functionality to check for
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/30588.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/35126.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/35127.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- trigger.model.load("Empty")
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/35128.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/46034.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/46040.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/46058.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- ```
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/46066.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- ```
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_2470/73595.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()

...
eventlog.overwritemethod = eventlog.DISCARD_NEWEST
...
eventlog.enable = eventlog.ENABLE
...
localnode.passwordmode = localnode.PASSWORD_NONE
...
bufferVar.fillmode = smua.FILL_ONCE
...
smua.cal.state = smua.CALSTATE_LOCKED
---@class smub.cal
smub.cal = {}
...
smub.cal.state = smub.CALSTATE_LOCKED
---@class smua.contact
smua.contact = {}
...
smub.measure.filter.enable = smub.FILTER_OFF
...
smub.measure.filter.type = smub.FILTER_MOVING_AVG
...
smub.measure.rel.enablev = smub.REL_OFF
...
smub.measure.rel.enablei = smub.REL_OFF
...
smub.measure.rel.enabler = smub.REL_OFF
...
smub.measure.rel.enablep = smub.REL_OFF
...
smua.trigger.endpulse.action = smua.SOURCE_IDLE1
...
smub.trigger.endpulse.action = smub.SOURCE_IDLE1

...
---@param end integer Defines the ending point in the buffer to stop saving data
---@overload fun(bufferVar:bufferVar,fileName:string)
---@overload fun(bufferVar:bufferVar,fileName:string,what:bufferFileSaveDetails)
function buffer.save(bufferVar, fileName, what, start, end) end
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2461/25630.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset() 
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2461/25640.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
--- This attribute contains the unit of measure that is stored with readings in the reading buffer.
---
---[command help](command:kic.viewHelpDocument?["Commands_2461/25641.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset() 
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2461/25706.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset() 
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2461/25707.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset() 
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2461/25712.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2461/25713.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset() 
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_2461/25715.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset() 
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2461/25716.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset() 
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_2461/30485.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2461/30488.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2461/30489.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2461/30538.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2461/30542.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_2461/30545.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset() 
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2461/30550.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset() 
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2461/30577.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset() 
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2461/33164.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset() 
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2461/34340.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset() 
...
bufferVar.sourcestatuses = buffer.STAT_OUTPUT
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2461/46323.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2461/56793.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2461/56794.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- test1 = buffer.make(100)
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2461/81089.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2461/81090.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- extBuffer = buffer.make(100, buffer.STYLE_WRITABLE_FULL)
...
triggertimerArr.enable = trigger.ON
...
smu.measure.displaydigits = smu.DIGITS_4_5
...
---@param count smusourcepulstraincount | number The number of pulses in the pulse train; default is 1
---@param measEnable smusourcepulsetrainmeasEnable Enable or disable measurements at the top of each pulse
---@param bufferName bufferVar The name of the reading buffer, which may be a default buffer (defbuffer1 or defbuffer2) or a user-defined buffer; defaults to defbuffer1
...
---@overload fun(configListName:string,biasLevel:number,pulseLevel:number,pulseWidth:number,count:smusourcepulstraincount | number)
---@overload fun(configListName:string,biasLevel:number,pulseLevel:number,pulseWidth:number,count:smusourcepulstraincount | number,measEnable:smusourcepulsetrainmeasEnable)
---@overload fun(configListName:string,biasLevel:number,pulseLevel:number,pulseWidth:number,count:smusourcepulstraincount | number,measEnable:smusourcepulsetrainmeasEnable,bufferName:bufferVar)
---@overload fun(configListName:string,biasLevel:number,pulseLevel:number,pulseWidth:number,count:smusourcepulstraincount | number,measEnable:smusourcepulsetrainmeasEnable,bufferName:bufferVar,sDelay:number)
---@overload fun(configListName:string,biasLevel:number,pulseLevel:number,pulseWidth:number,count:smusourcepulstraincount | number,measEnable:smusourcepulsetrainmeasEnable,bufferName:bufferVar,sDelay:number,offTime:number)
---@overload fun(configListName:string,biasLevel:number,pulseLevel:number,pulseWidth:number,count:smusourcepulstraincount | number,measEnable:smusourcepulsetrainmeasEnable,bufferName:bufferVar,sDelay:number,offTime:number,xBiasLimit:number)
---@overload fun(configListName:string,biasLevel:number,pulseLevel:number,pulseWidth:number,count:smusourcepulstraincount | number,measEnable:smusourcepulsetrainmeasEnable,bufferName:bufferVar,sDelay:number,offTime:number,xBiasLimit:number,xPulseLimit:number)
...
---@param sDelay number The amount of time that the instrument stays at bias level before each pulse (in seconds)
---@param offTime number The amount of time that the instrument stays at bias level after each pulse (in seconds)
---@param count smusourcepulsesweeplinearstepcount | number The number of pulse sweeps; default is 1
---@param xBiasLimit number The current or voltage limit for the defined bias level
---@param xPulseLimit number The current or voltage limit for the defined pulse level
...
---@overload fun(configListName:string,biasLevel:number,start:number,stop:number,step:number,pulseWidth:number,measEnable:smusourcepulsesweeplinearstepmeasEnable,bufferName:bufferVar)
---@overload fun(configListName:string,biasLevel:number,start:number,stop:number,step:number,pulseWidth:number,measEnable:smusourcepulsesweeplinearstepmeasEnable,bufferName:bufferVar,sDelay:number)
---@overload fun(configListName:string,biasLevel:number,start:number,stop:number,step:number,pulseWidth:number,measEnable:smusourcepulsesweeplinearstepmeasEnable,bufferName:bufferVar,sDelay:number,offTime:number)
---@overload fun(configListName:string,biasLevel:number,start:number,stop:number,step:number,pulseWidth:number,measEnable:smusourcepulsesweeplinearstepmeasEnable,bufferName:bufferVar,sDelay:number,offTime:number,count:smusourcepulsesweeplinearstepcount | number)
---@overload fun(configListName:string,biasLevel:number,start:number,stop:number,step:number,pulseWidth:number,measEnable:smusourcepulsesweeplinearstepmeasEnable,bufferName:bufferVar,sDelay:number,offTime:number,count:smusourcepulsesweeplinearstepcount | number,xBiasLimit:number)
---@overload fun(configListName:string,biasLevel:number,start:number,stop:number,step:number,pulseWidth:number,measEnable:smusourcepulsesweeplinearstepmeasEnable,bufferName:bufferVar,sDelay:number,offTime:number,count:smusourcepulsesweeplinearstepcount | number,xBiasLimit:number,xPulseLimit:number)
---@overload fun(configListName:string,biasLevel:number,start:number,stop:number,step:number,pulseWidth:number,measEnable:smusourcepulsesweeplinearstepmeasEnable,bufferName:bufferVar,sDelay:number,offTime:number,count:smusourcepulsesweeplinearstepcount | number,xBiasLimit:number,xPulseLimit:number,failAbort:smusourcepulsesweeplinearstepfailAbort)
...
---@param sDelay number The amount of time that the instrument stays at bias level before each pulse (in seconds)
---@param offTime number The amount of time that the instrument stays at bias level after each pulse (in seconds)
---@param count smusourcepulsesweeplinearcount | number The number of pulse sweeps; default is 1
---@param xBiasLimit number The current or voltage limit for the defined bias level
---@param xPulseLimit number The current or voltage limit for the defined pulse level
...
---@overload fun(configListName:string,biasLevel:number,start:number,stop:number,points:number,pulseWidth:number,measEnable:smusourcepulsesweeplinearmeasEnable,bufferName:bufferVar)
---@overload fun(configListName:string,biasLevel:number,start:number,stop:number,points:number,pulseWidth:number,measEnable:smusourcepulsesweeplinearmeasEnable,bufferName:bufferVar,sDelay:number)
---@overload fun(configListName:string,biasLevel:number,start:number,stop:number,points:number,pulseWidth:number,measEnable:smusourcepulsesweeplinearmeasEnable,bufferName:bufferVar,sDelay:number,offTime:number)
---@overload fun(configListName:string,biasLevel:number,start:number,stop:number,points:number,pulseWidth:number,bufferName:bufferVar,sDelay:number,offTime:number,count:smusourcepulsesweeplinearcount | number)
---@overload fun(configListName:string,biasLevel:number,start:number,stop:number,points:number,pulseWidth:number,bufferName:bufferVar,sDelay:number,offTime:number,count:smusourcepulsesweeplinearcount | number,xBiasLimit:number)
---@overload fun(configListName:string,biasLevel:number,start:number,stop:number,points:number,pulseWidth:number,measEnable:smusourcepulsesweeplinearmeasEnable,bufferName:bufferVar,sDelay:number,offTime:number,count:smusourcepulsesweeplinearcount | number,xBiasLimit:number,xPulseLimit:number)
---@overload fun(configListName:string,biasLevel:number,start:number,stop:number,points:number,pulseWidth:number,measEnable:smusourcepulsesweeplinearmeasEnable,bufferName:bufferVar,sDelay:number,offTime:number,count:smusourcepulsesweeplinearcount | number,xBiasLimit:number,xPulseLimit:number,failAbort:smusourcepulsesweeplinearfailAbort)
...
---@param sDelay number The amount of time that the instrument stays at bias level before each pulse (in seconds)
---@param offTime number The amount of time that the instrument stays at bias level after each pulse (in seconds)
---@param count smusourcepulsesweeplogcount | number The number of pulse sweeps; default is 1
---@param xBiasLimit number The current or voltage limit for the defined bias level
---@param xPulseLimit number The current or voltage limit for the defined pulse level
...
---@overload fun(configListName:string,biasLevel:number,start:number,stop:number,points:number,pulseWidth:number,measEnable:smusourcepulsesweeplogmeasEnable,bufferName:bufferVar)
---@overload fun(configListName:string,biasLevel:number,start:number,stop:number,points:number,pulseWidth:number,measEnable:smusourcepulsesweeplogmeasEnable,bufferName:bufferVar,sDelay:number)
---@overload fun(configListName:string,biasLevel:number,start:number,stop:number,points:number,pulseWidth:number,measEnable:smusourcepulsesweeplogmeasEnable,bufferName:bufferVar,sDelay:number,offTime:number)
---@overload fun(configListName:string,biasLevel:number,start:number,stop:number,points:number,pulseWidth:number,measEnable:smusourcepulsesweeplogmeasEnable,bufferName:bufferVar,sDelay:number,offTime:number,count:smusourcepulsesweeplogcount | number)
---@overload fun(configListName:string,biasLevel:number,start:number,stop:number,points:number,pulseWidth:number,measEnable:smusourcepulsesweeplogmeasEnable,bufferName:bufferVar,sDelay:number,offTime:number,count:smusourcepulsesweeplogcount | number,xBiasLimit:number)
---@overload fun(configListName:string,biasLevel:number,start:number,stop:number,points:number,pulseWidth:number,measEnable:smusourcepulsesweeplogmeasEnable,bufferName:bufferVar,sDelay:number,offTime:number,count:smusourcepulsesweeplogcount | number,xBiasLimit:number,xPulseLimit:number)
---@overload fun(configListName:string,biasLevel:number,start:number,stop:number,points:number,pulseWidth:number,measEnable:smusourcepulsesweeplogmeasEnable,bufferName:bufferVar,sDelay:number,offTime:number,count:smusourcepulsesweeplogcount | number,xBiasLimit:number,xPulseLimit:number,failAbort:smusourcepulsesweeplogfailAbort)
---@overload fun(configListName:string,biasLevel:number,start:number,stop:number,points:number,pulseWidth:number,measEnable:smusourcepulsesweeplogmeasEnable,bufferName:bufferVar,sDelay:number,offTime:number,count:smusourcepulsesweeplogcount | number,xBiasLimit:number,xPulseLimit:number,failAbort:smusourcepulsesweeplogfailAbort,dual:smusourcepulsesweeplogdual)
...
---@param bufferName bufferVar The name of the reading buffer, which may be a default buffer (defbuffer1 or defbuffer2) or a user-defined buffer; defaults to defbuffer1
---@param count smusourcepulsesweeplistcount | number The number of pulse sweeps; default is 1
---@param sDelay number The amount of time that the instrument stays at bias level before each pulse (in seconds)
---@param offTime number The amount of time that the instrument stays at bias level after each pulse (in seconds)
...
---@overload fun(configListName:string,pulseWidth:number,measEnable:smusourcepulsesweeplistmeasEnable,bufferName:bufferVar)
---@overload fun(configListName:string,pulseWidth:number,measEnable:smusourcepulsesweeplistmeasEnable,bufferName:bufferVar)
---@overload fun(configListName:string,pulseWidth:number,measEnable:smusourcepulsesweeplistmeasEnable,bufferName:bufferVar,count:smusourcepulsesweeplistcount | number)
---@overload fun(configListName:string,pulseWidth:number,measEnable:smusourcepulsesweeplistmeasEnable,bufferName:bufferVar,count:smusourcepulsesweeplistcount | number,sDelay:number)
---@overload fun(configListName:string,pulseWidth:number,measEnable:smusourcepulsesweeplistmeasEnable,bufferName:bufferVar,count:smusourcepulsesweeplistcount | number,sDelay:number,offTime:number)
...
digiolineArr.state = digio.STATE_HIGH
...
digiolineArr.mode = digio.MODE_TRIGGER_IN
...
triggerdiginArr.edge = trigger.EDGE_EITHER
...
triggertsplinkinArr.edge = trigger.EDGE_EITHER
...
---@param ... string A string that contains the names of subsequent buttons, where N is a number from 2 to 10; you can define up to 10 buttons; each button can be up to 15 characters
function display.input.option(dialogTitle, buttonTitle1, ...) end
...
--- ```
---@return number reading The last reading of the measurement process
---@param bufferName bufferVar The name of the reading buffer, which may be a default buffer (defbuffer1 or defbuffer2) or a user-defined buffer; if nothing is specified, the reading is stored in defbuffer1
---@overload fun():reading:number
...
--- ```
---@type any
smu.digitize.displaydigits = smu.DIGITS_4_5
...
---@return number seconds Seconds in UTC format
---@return number fractional Fractional seconds
---@param bufferName bufferVar The name of the reading buffer, which may be a default buffer (defbuffer1 or defbuffer2) or a user-defined buffer; if no buffer is specified, this parameter defaults to defbuffer1
---@overload fun():reading:number, seconds:number, fractional:number
...
--- ```
---@type any
smu.digitize.unit = smu.UNIT_AMP
...
--- ```
---@type any
smu.contact.threshold = smu.THRESHOLD_50_OHM
...
smumeasurelimitArr.fail = smu.FAIL_LOW
...
---@type any
smudigitizelimitArr.fail = smu.FAIL_LOW
...
--- --Never: smu.AUDIBLE_NONEOn test failure: smu.AUDIBLE_FAILOn test pass: smu.AUDIBL--- ```
---@type any
smudigitizelimitArr.audible = smu.AUDIBLE_FAIL
...
--- ```
---@type any
smu.digitize.rel.enable = smu.OFF

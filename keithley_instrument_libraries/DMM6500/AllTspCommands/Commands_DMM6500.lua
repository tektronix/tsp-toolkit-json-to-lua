...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/13987.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/13988.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- for name in userstring.catalog() do
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/13989.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/13990.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- userstring.add("assetnumber", "236")
...
---
--- *Details:*<br>
--- When upgrade.unit() is used, the firmware is only loaded if the version of the firmware is newer than the existing version. If the version is older or at the same revision level, it is not upgraded.When you send this function, the instrument searches the USB flash drive in the front-panel USB port for an upgrade file. If the file is found, the instrument verifies that the file is a newer version. If the version is older or at the same revision level, it is not upgraded, although it does request a reboot. If it is a newer version, the instrument performs the upgrade. An error event message is returned if no upgrade file is found.If you have a communications accessory card (KTTI-GPIB, KTTI-TSP, or KTTI-RS232) installed in the instrument, the firmware on the card is also upgraded.
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/14063.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- ```
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/14073.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
--- *Details:*<br>
--- This command connects a device to another device through the LAN interface. If the portNumber is 23, the interface uses the Telnet protocol and sets appropriate termination characters to communicate with the device.If a portNumber and initString are provided, it is assumed that the remote device is not TSP-enabled. The DMM6500 does not perform any extra processing, prompt handling, error handling, or sending of commands. In addition, the tspnet.tsp.* commands cannot be used on devices that are not TSP-enabled.If neither a portNumber nor an initString is provided, the remote device is assumed to be a Keithley Instruments TSP-enabled device. Depending on the state of the tspnet.tsp.abortonconnect attribute, the DMM6500 sends an abort command to the remote device on connection. You can simultaneously connect to a maximum of 32 remote devices.
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/14074.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/14076.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- This function retrieves the response of the remote device to *IDN?.
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/14078.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- --KEITHLEY INSTRUMENTS,MODEL DMM6500,01418035,1.0.0a
--- ```
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/14080.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/14081.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- ```
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/14084.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- tspnet.timeout = 2.0
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/34363.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- deviceID = tspnet.connect("192.0.2.1")
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/14654.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dataqueue.clear()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/14655.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/14656.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- MaxCount = dataqueue.CAPACITY
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/14657.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- MaxCount = dataqueue.CAPACITY
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/14658.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dataqueue.clear()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/14808.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/14810.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- if fs.is_dir("/usb1/temp") == true then
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/14811.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/14812.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- if fs.is_dir("/usb1/temp") == false then
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/14814.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- rootDirectory = "/usb1/"
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/14815.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- rootDirectory = "/usb1/"
...
--- The file system path may be absolute or relative to the current working system path.
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/14824.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- rootDirectory = "/usb1/"
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/14860.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- gpib.address = 26
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/14893.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- print(lan.lxidomain)
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/25725.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/28423.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/15009.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/15010.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/15020.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/15013.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/25726.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/30504.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/32416.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- print(os.date('%c', gettime()))
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/32595.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/32597.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- display.clear()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/32628.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/33140.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/33148.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
--- *Details:*<br>
--- When the access to the instrument is set to protected or lockout, this is the password that is used to gain access.If you forget the password, you can reset the password to the default:
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/34629.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/40235.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/15285.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- tsplink.group = 3
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/15287.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- tsplink.node = 3
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/15289.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/15291.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- state = tsplink.state
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/15302.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- tsplink.writeport(3)
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/30551.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/32565.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/25637.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- *TRG
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/25639.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/30574.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31094.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31096.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31097.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31098.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31101.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31102.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31103.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31105.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31107.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31108.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31109.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31110.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31112.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31114.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31347.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/35428.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/35431.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41689.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- trigger.model.load("Empty")
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/75110.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/75112.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/88463.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/35753.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41309.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- print(dmm.terminals)
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/16254.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- trigger.model.initiate()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/16255.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/16973.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- scan.bypass = scan.ON
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/16974.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- scan.create("1:9")
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/72434.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- scan.create("1:4")
...
---
--- *Details:*<br>
--- If the restart option is enabled, the scan settings are saved in memory immediately after the scan is triggered and before the scan operation begins. All scan settings, including watched channels, need to be set before the scan starts. Any changes that are made after the scan starts are not recalled if power is lost and the scan needs to restart.If the restart option is enabled and power is lost, the scan restarts when power is restored. The scan setup that was in place when the scan started becomes the power-up setup. It takes precedence over any other power-up setup. If the scan completes successfully, the scan setup is removed as the power-up setup.If the DMM6500 detects that a card was changed during the power-up sequence, restart is set to off, the interrupted scan is not resumed, and an event is generated. The instrument starts up normally.When a scan is automatically restarted, it is logged in the event log.
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/72474.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/72541.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- scan.scaninterval = 5
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/72544.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/73677.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- scan.create("1:5")
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/74579.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- scan.create("1:9")
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/74583.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- scan.create("1:4")
...
---
--- *Details:*<br>
--- This command lists the existing scan list, including each step in the scan and information for step, open, or close status.If the scan list is empty, the return is EMPTY.
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/74593.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- channel.setdmm("1:5", dmm.ATTR_MEAS_FUNCTION, dmm.FUNC_DC_VOLTAGE)
...
--- ```
---@return string scanList A string that lists information for each scan step
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/81331.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/16856.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- test8.run()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/16863.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- test8.save()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/33395.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- print(test7.source)
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/17247.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- channelList = "1:3"
...
---@param channelList string A string that lists the channels to be queried (including allslots or slot1 to get information on all channels); returns all slots if nothing is specified
---@overload fun():string
...
---
--- *Details:*<br>
--- The DMM6500 keeps an internal count of the number of times each relay has been closed. This count can help you determine when relays require replacement. Refer to the scanner card documentation for the contact life specifications for the relays.If channels are specified, the count values are returned in the order in which the channels are specified. If slots are specified, the response lists the channels starting from lowest to highest.Relay closures are counted only when a relay cycles from open to closed state.It is good practice to get the relay count at the end of a program. This saves the latest count to memory.
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/17384.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/17547.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/72238.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/72277.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- channel.setlabel('1', 'First')
--- channel.setlabel('2', 'Second')
--- channel.setlabel('3', 'Third')
--- print(channel.getlabel('1'))
--- print(channel.getlabel('2'))
--- print(channel.getlabel('3'))
--- 
...
---
--- *Details:*<br>
--- The action of the close command depends on which, if any, function is set for the DMM.If no function is set, the listed channels or channel pairs are closed. You can select multiple channels.If the DMM for the channel is set to a function, the listed channels or channel pairs are closed. In addition, it opens channels or channel pairs that could affect the measurements. When a channel is set to a function, only one channel can be specified in the channel list.When you close a channel or channel pair, the instrument:Use the channel.getclose() command to return a list of closed measurement channels, including the paired channels for 4-wire measurements.
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/72855.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- channel.close("1")
...
--- 
--- --This example closes channels 1 and 2, then opens all channels.
--- channel.open("slot1")
--- 
--- --Opens all channels.
--- channel.open("allslots")
...
--- --Opens all channels.
--- ```
---@param channelList string String listing the channels to open; allslots and slot1 are available; both open all channels
...
---
--- *Details:*<br>
--- This command returns the closed or open state of a channel.Cards are returned sequentially by channel number.Each bit in the return represents a different indicator. Therefore, multiple indicators can be present (the OR operation is performed bitwise).Possible returns are:
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/74635.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- channel.close("5")  
--- State = channel.getstate("1:7")
--- print(State)
--- 
--- --Close channel 5.
--- --Query the state of the first seven channels.
--- --View the response assigned to State.
--- --Output:
--- --[1]=0, [2]=0, [3]=0, [4]=0, [5]=channel.IND_CLOSED, [6]=0, [7]=0
--- ```
---@return any state Return a comma-delimited string that lists the states for the channels in channelList; refer to Details
---@param channelList any String specifying the channels to query; use normal channel list syntax; if no channels are defined, all channels are returned
---@overload fun():any
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/75072.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---@param channelList string A string listing the channels to query for their delay times; slot1 or allslots allowed
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/75075.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/75086.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- channel.setlabel('1', 'First')
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/25624.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/25629.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/25642.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
--- *Details:*<br>
--- The file name must specify the full path (including /usb1/). If included, the file extension must be set to .csv. If no file extension is specified, .csv is added.Examples of valid destination file names:The DMM6500 does not check for existing files when you save. Verify that you are using a unique name to avoid overwriting any existing CSV files on the flash drive.
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/33210.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/33981.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/34560.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- buffer.clearstats()
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/72427.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/73595.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/76401.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/25635.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dataqueue.clear()
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/25636.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dataqueue.clear()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/25702.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/27637.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- ```
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/27658.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/30552.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/34730.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- eventlog.clear()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/25719.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/25722.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- display.clear()
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/30502.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- display.clear()
...
---
--- *Details:*<br>
--- The scan and channel options are only available if you have a card installed and if the front-panel TERMINALS switch is set to REAR.
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/30503.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- display.clear()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/33260.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/33261.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/33459.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/38977.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/81506.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/81840.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/25723.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- file.mkdir("TestData")
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/25724.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/27929.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/27930.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/27934.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/27958.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/34905.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- local response
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/28048.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- x = 1.23
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/28056.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/28063.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- format.asciiprecision = 10
...
---
--- *Details:*<br>
--- You can use the beeper of the instrument to provide an audible signal at a specific frequency and time duration.Using this function from a remote interface does not affect audible errors or key click settings that were made from the DMM6500 front panel.
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/29636.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- beeper.beep(2, 2400)
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/30567.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- status.clear()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31635.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/32386.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/33635.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- status.preset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/30981.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- digio.writeport(63)
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31368.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- data = digio.readport()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/33286.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/33290.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/33394.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- script.delete("test8")
...
---
--- *Details:*<br>
--- The information that is returned depends on whether the scanner card in the slot is a physical card or pseudocard.For physical cards, this returns a comma-separated string that contains the model number, description, firmware revision, and serial number of the scanner card installed in the specified slot.For pseudocards, the response is Pseudo, followed by the model number, description, and ??? for the firmware revision and serial number.
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/77548.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- print(slot[1].idn)
--- 
--- --If a 2000-SCAN card is installed, the response is similar to:
--- --2000,10-Chan Mux,0.00e,1243657
--- ```
...
---
--- *Details:*<br>
--- Pseudocards allow you to configure your system without having an actual scanner card installed in your system. You can perform open, close, and scan operations and configure your system with pseudocards.This command is only applicable to a slot that does not have a scanner card or pseudocard installed. If a pseudocard is presently assigned to the slot, you must set the slot to no pseudocard before assigning the new pseudocard.After assigning a pseudocard, you can use valid commands for the scanner card for that slot.Changing the pseudocard assignment from a pseudocard to no pseudocard invalidates scan lists that include that slot.If a scanner card is installed in the slot, this command returns nil. If the slot is empty and no pseudocard is installed, the return is 0.
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/77555.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- print(slot[1].idn)
--- 
--- --Sets the slot to no pseudocard, then sets it to simulate a 2000-SCAN or 2001-TCSCAN card. Output is similar to:
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/77649.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- maxVolts2 = slot[1].maxvoltage
--- print(maxVolts2)
--- 
--- --Query the maximum voltage. The output is similar to:
--- --110
--- ```
---@class tspnet.tsp
tspnet.tsp = {}
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/14085.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/14086.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/14090.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- tspnet.timeout = 5
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/32684.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/15785.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/15787.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/15788.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/17666.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/35118.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/77678.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- digio.line[3].mode = digio.MODE_TRIGGER_IN
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/15793.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/15794.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/15795.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/15800.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/15820.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/30576.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31076.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/16068.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- channel.setdmm("1:5", dmm.ATTR_MEAS_THERMOCOUPLE, dmm.THERMOCOUPLE_J, dmm.ATTR_MEAS_SIM_REF_TEMP, 30)
--- 
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31441.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- trigger.model.load("Empty")
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31457.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/40942.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_DC_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/40948.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41099.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_DC_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41117.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_DC_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41141.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41144.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_DC_VOLTAGE
...
--- channel.setdmm("1:10", dmm.ATTR_MEAS_FUNCTION, dmm.FUNC_DC_VOLTAGE)
--- channel.setdmm("1:10", dmm.ATTR_MEAS_UNIT, dmm.UNIT_DB)
--- channel.setdmm("1:10", dmm.ATTR_MEAS_DB_REFERENCE, 5)
--- 
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41147.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41175.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_TEMPERATURE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41176.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_TEMPERATURE
...
dmm.TRANS_FOURRTDCJC2001 = nil
dmm.TRANS_CJC2001 = nil
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41181.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_TEMPERATURE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41182.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_TEMPERATURE
...
--- This attribute is only valid when:
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41186.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_TEMPERATURE
...
--- This attribute is only valid when:
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41188.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_TEMPERATURE
...
--- This attribute is only valid when:
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41191.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_TEMPERATURE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41192.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_TEMPERATURE
...
--- channel.setdmm("1:5", dmm.ATTR_MEAS_FUNCTION, dmm.FUNC_TEMPERATURE)
--- channel.setdmm("1:5", dmm.ATTR_MEAS_TRANSDUCER, dmm.TRANS_THERMISTOR)
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41197.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_TEMPERATURE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41233.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- channel.setdmm("1:9", dmm.ATTR_MEAS_FUNCTION, dmm.FUNC_DC_VOLTAGE)
--- channel.setdmm("1:9", dmm.ATTR_MEAS_LINE_SYNC, dmm.ON)
--- 
--- --For channels 1 through 9 on slot 1, set the DMM function to DC voltage.
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41296.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.count = 10
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41301.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_DC_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41303.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_TEMPERATURE
...
--- channel.setdmm("1:4", dmm.ATTR_MEAS_FUNCTION, dmm.FUNC_TEMPERATURE)
--- channel.setdmm("1:4", dmm.ATTR_MEAS_TRANSDUCER, dmm.TRANS_THERMOCOUPLE)
--- channel.setdmm("1:4", dmm.ATTR_MEAS_OPEN_DETECTOR, dmm.OFF)
--- 
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41304.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41308.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_DC_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41421.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_RESISTANCE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/44539.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_DC_VOLTAGE
...
---
--- *Details:*<br>
--- Only available when the temperature function is selected and the transducer type is set to thermocouple.When you are making rear terminal measurements, you can select the external option. When the external option is selected, the temperature is updated when the external reference function channel is scanned.When you are making front terminal measurements, the only option is simulated. You can set the simulated reference temperature with the command dmm.measure.simreftemperature.
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/73436.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_TEMPERATURE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/73701.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_TEMPERATURE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/81432.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_DC_VOLTAGE
...
--- channel.setdmm("1:10", dmm.ATTR_MEAS_FUNCTION, dmm.FUNC_DC_VOLTAGE)
--- channel.setdmm("1:10", dmm.ATTR_MEAS_UNIT, dmm.UNIT_DBM)
--- channel.setdmm("1:10", dmm.ATTR_MEAS_DBM_REFERENCE, 5)
--- 
--- --For channels 1 through 10, set the DMM function to DC voltage.
--- --Set the units to decibel-milliwatts.
--- --Set the dBm reference to 5 V.
--- ```
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/91266.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/91267.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/25628.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- trigger.model.abort()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/25741.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/30569.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/30570.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/30571.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- ```
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/30588.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/35126.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/35127.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- trigger.model.load("Empty")
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/35128.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/46034.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/46040.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/72471.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/73512.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/28111.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31397.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31398.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31413.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/30523.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31637.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31638.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31639.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31648.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/30524.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- You can map events to bits in the event registers with this command. This allows you to cause bits in the condition and event registers to be set or cleared when the specified events occur. You can use any valid event number as the event that sets or clears bits.When a mapped event is programmed to set bits, the corresponding bits in both the condition register and event register are set when the event is detected.When a mapped event is programmed to clear bits, the bit in the condition register is set to 0 when the event is detected.If the event is set to zero (0), the bit is never set.
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31612.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- When you query the mapping for a specific bit, the instrument returns the events that were mapped to set and clear that bit. Zero (0) indicates that the bits have not been set.
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31613.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31614.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31615.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/30525.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31653.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/30982.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31363.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31393.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31360.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31373.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31378.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31394.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- digio.line[4].mode = digio.MODE_TRIGGER_IN
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31385.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31392.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31395.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- digio.line[4].mode = digio.MODE_TRIGGER_OUT
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/33159.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- digio.line[4].mode = digio.MODE_TRIGGER_OUT
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/77679.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- digio.line[2].mode = digio.MODE_TRIGGER_OUT
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31396.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31401.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31404.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- ```
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31406.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- trigger.lanout[1].protocol = lan.PROTOCOL_MULTICAST
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31409.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/31416.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/33157.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/77682.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/32538.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/32541.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/32542.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/32539.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- tsplink.line[3].mode = tsplink.MODE_TRIGGER_OPEN_DRAIN
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/32551.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- This command indicates whether an event has been ignored because the event detector was already in the detected state when the event occurred.This is an indication of the state of the event detector built into the synchronization line itself.It does not indicate if an overrun occurred in any other part of the trigger model, or in any other construct that is monitoring the event. It also is not an indication of an output trigger overrun.
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/32552.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/32561.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- tsplink.line[3].mode = tsplink.MODE_TRIGGER_OPEN_DRAIN
...
--- This attribute controls the logic that the output trigger generator uses on the given trigger line.The output state of the digital I/O line is controlled by the trigger logic, and the user-specified output state of the line is ignored.
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/32540.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- tsplink.line[3].mode = tsplink.MODE_TRIGGER_OPEN_DRAIN
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/32549.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- tsplink.line[2].mode = tsplink.MODE_TRIGGER_OPEN_DRAIN
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/32553.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- tsplink.line[3].mode = tsplink.MODE_TRIGGER_OPEN_DRAIN
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/32555.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- tsplink.line[3].mode = tsplink.MODE_TRIGGER_OPEN_DRAIN
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/77684.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/40051.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_DC_VOLTAGE
...
--- 
--- --This example displays a number pad on the screen that defaults to 0 and allows entries from u1000 to 1000. The number that the operator enters is assigned to the relative offset level. If the operator enters a value outside of the range, an error message is displayed.
--- --
--- ```
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/40052.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/40053.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/40054.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41093.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- voltMeasBuffer = buffer.make(10000)
...
--- This command affects how the reading for a measurement is displayed on the front panel of the instrument. It does not affect the number of digits returned in a remote command reading. It also does not affect the accuracy or speed of measurements.The display digits setting is saved with the function setting, so if you use another function, then return to the function for which you set display digits, the display digits setting you set previously is retained.The change in digits occurs the next time a measurement is made.To change the number of digits returned in a remote command reading, use format.asciiprecision.
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41150.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- To use this command in a trigger model, assign the delay to the dynamic delay block.The delay is specific to the selected function.
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41269.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.digitize.func = dmm.FUNC_DIGITIZE_CURRENT
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41297.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.digitize.func = dmm.FUNC_DIGITIZE_CURRENT
...
--- channel.setdmm("1, 6", dmm.ATTR_DIGI_SAMPLE_RATE, 200000, dmm.ATTR_DIGI_APERTURE, dmm.APERTURE_AUTO, dmm.ATTR_DIGI_COUNT, 1)
--- channel.close("1")
--- print(dmm.digitize.read())
--- channel.close("6")
--- print(dmm.digitize.read())
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41306.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.digitize.func = dmm.FUNC_DIGITIZE_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41428.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.digitize.func = dmm.FUNC_DIGITIZE_CURRENT
...
--- channel.setdmm("1:3", dmm.ATTR_DIGI_RANGE, 100, dmm.ATTR_DIGI_DIGITS, dmm.DIGITS_5_5, dmm.ATTR_DIGI_SAMPLE_RATE, 1000, dmm.ATTR_DIGI_COUNT, 1000)
--- 
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41431.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.digitize.func = dmm.FUNC_DIGITIZE_CURRENT
...
---
--- *Details:*<br>
--- The sample rate determines how fast the DMM6500 acquires a digitized reading.Set the sample rate before setting the aperture. If the aperture setting is too high for the selected sample rate, it is automatically adjusted to the highest aperture that can be used with the sample rate.
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41433.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.digitize.func = dmm.FUNC_DIGITIZE_CURRENT
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41622.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- The change in measurement units is displayed when the next measurement is made. You can only change the units for the listed functions.
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/43717.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.digitize.func = dmm.FUNC_DIGITIZE_VOLTAGE
...
--- channel.setdmm("1:3", dmm.ATTR_DIGI_FUNCTION, dmm.FUNC_DIGITIZE_VOLTAGE)
--- channel.setdmm("1:3", dmm.ATTR_DIGI_UNIT, dmm.UNIT_DB, dmm.ATTR_DIGI_DB_REFERENCE, 1e-6, dmm.ATTR_DIGI_SAMPLE_RATE, 1000, dmm.ATTR_DIGI_COUNT, 1000)
--- 
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/44541.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.digitize.func = dmm.FUNC_DIGITIZE_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/46371.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.digitize.func = dmm.FUNC_DIGITIZE_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/81719.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.digitize.func = dmm.FUNC_DIGITIZE_VOLTAGE
...
--- channel.setdmm("1:10", dmm.ATTR_DIGI_FUNCTION, dmm.FUNC_DIGITIZE_VOLTAGE)
--- channel.setdmm("1:10", dmm.ATTR_DIGI_UNIT, dmm.UNIT_DBM)
--- channel.setdmm("1:10", dmm.ATTR_DIGI_DBM_REFERENCE, 85)
--- 
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41331.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- trigger.extin.clear()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41332.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- If this is true, an event was ignored because the event detector was already in the detected state when the event occurred.This is an indication of the state of the event detector built into the line itself. It does not indicate if an overrun occurred in any other part of the trigger model or in any other detector that is monitoring the event.
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41333.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41334.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41335.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41336.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- trigger.ext.reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/77680.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41343.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/46427.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/46428.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- extBuffer = buffer.make(100, buffer.STYLE_WRITABLE)
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/72204.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/72205.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- channel.multiple.open("2, 3, 4")
--- 
--- --Open channels 2, 3, and 4.
--- ```
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/72278.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/72279.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/72280.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/75013.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- scan.create("1:9")
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/72552.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- channel.setdmm("1:5", dmm.ATTR_MEAS_FUNCTION, dmm.FUNC_DC_VOLTAGE)
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/72565.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- channel.setdmm("1:5", dmm.ATTR_MEAS_FUNCTION, dmm.FUNC_DC_VOLTAGE)
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/77651.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/77652.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- print(slot[1].voltage.startchannel)
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/25691.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/28417.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/28418.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/28419.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/28421.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/30559.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/32926.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/91273.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.configlist.create("MyMeasList")
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/29049.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41122.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_DC_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/30536.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- trigger.timer[4].reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/30553.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/33984.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- This command configures the alarm of the timer.When the timer is enabled, the timer starts immediately if the timer is configured for a start time that has passed.
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/33985.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/77683.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- digio.line[3].mode = digio.MODE_TRIGGER_IN
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41157.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_DC_CURRENT
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41161.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_DC_CURRENT
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41167.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_DC_CURRENT
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41173.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_RESISTANCE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41208.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.FUNC_DC_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41212.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.FUNC_DC_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41214.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.FUNC_DC_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41231.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.FUNC_DC_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41684.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.FUNC_DC_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41210.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.digitize.func = dmm.FUNC_DIGITIZE_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41213.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.digitize.func = dmm.FUNC_DIGITIZE_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41221.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- value
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41225.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- state
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41685.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- value
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41235.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_DC_VOLTAGE
...
--- channel.setdmm("1", dmm.ATTR_MEAS_MATH_FORMAT, dmm.MATH_PERCENT, dmm.ATTR_MEAS_MATH_ENABLE, dmm.ON )
---  
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41245.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_DC_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41248.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_DC_VOLTAGE
...
--- -- and enable math.
--- channel.setdmm("1", dmm.ATTR_MEAS_MATH_FORMAT, dmm.MATH_PERCENT, dmm.ATTR_MEAS_MATH_PERCENT, 42, dmm.ATTR_MEAS_MATH_ENABLE, dmm.ON)
--- 
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41236.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.digitize.func = dmm.FUNC_DIGITIZE_CURRENT
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41275.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.digitize.func = dmm.FUNC_DIGITIZE_CURRENT
...
--- channel.setdmm("1:3", dmm.ATTR_DIGI_FUNCTION, dmm.FUNC_DIGITIZE_VOLTAGE)
--- channel.setdmm("1:3", dmm.ATTR_DIGI_REL_LEVEL, 1, dmm.ATTR_DIGI_REL_ENABLE, dmm.ON)
--- 
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41280.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.digitize.func = dmm.FUNC_DIGITIZE_CURRENT
...
--- When this command is set to on, the math operation specified by the math format command is performed before completing a measurement.
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41240.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.digitize.func = dmm.FUNC_DIGITIZE_VOLTAGE
...
--- channel.setdmm("1", dmm.ATTR_DIGI_FUNCTION, dmm.FUNC_DIGITIZE_VOLTAGE)
--- -- Set channel 1 to use the percentage math format and enable math.
--- channel.setdmm("1", dmm.ATTR_DIGI_MATH_FORMAT, dmm.MATH_PERCENT, dmm.ATTR_DIGI_MATH_ENABLE, dmm.ON )
---  
--- -- Acquire one reading to use as the relative percent value.
--- channel.close("1")
--- dmm.digitize.count = 1
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41243.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.digitize.func = dmm.FUNC_DIGITIZE_VOLTAGE
...
--- channel.setdmm("1", dmm.ATTR_DIGI_MATH_FORMAT, dmm.MATH_RECIPROCAL, dmm.ATTR_DIGI_MATH_ENABLE, dmm.ON)
--- 
...
--- The percent math function displays measurements as percent deviation from a specified reference constant. The percent calculation is:Where:
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41257.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.digitize.func = dmm.FUNC_DIGITIZE_CURRENT
...
--- -- Set channel 1 to use the percentage math format, set the percentage,
--- -- and enable math.
--- channel.setdmm("1", dmm.ATTR_DIGI_MATH_FORMAT, dmm.MATH_PERCENT, dmm.ATTR_DIGI_MATH_PERCENT, 42, dmm.ATTR_DIGI_MATH_ENABLE, dmm.ON)
--- 
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41259.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_TEMPERATURE
...
--- channel.setdmm("1:4", dmm.ATTR_MEAS_FUNCTION, dmm.FUNC_TEMPERATURE)
--- channel.setdmm("1:4", dmm.ATTR_MEAS_TRANSDUCER, dmm.TRANS_FOURRTD)
--- channel.setdmm("1:4", dmm.ATTR_MEAS_OFFCOMP_ENABLE, dmm.OCOMP_OFF)
--- channel.setdmm("1:4", dmm.ATTR_MEAS_FOUR_RTD, dmm.RTD_PT3916)
--- 
--- --For channels 1 through 4, set the DMM function to temperature.
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41271.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_AC_CURRENT
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41272.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_DC_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41273.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_DC_CURRENT
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41691.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41283.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41289.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_ACV_PERIOD
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41389.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_DC_CURRENT
...
--- When edge is selected, the analog trigger occurs when the signal crosses a certain level. You also specify if the analog trigger occurs on the rising or falling edge of the signal.When window is selected, the analog trigger occurs when the signal enters or exits the window defined by the low and high signal levels.
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41391.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.digitize.func = dmm.FUNC_DIGITIZE_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41438.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- channel.setdmm("1:9", dmm.ATTR_MEAS_FUNCTION, dmm.FUNC_DIODE)
--- channel.setdmm("1:9", dmm.ATTR_MEAS_BIAS_LEVEL, 0.0001)
--- 
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/76068.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_DCV_RATIO
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/89273.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_DCV_RATIO
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41215.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
--- channel.setdmm("1:2", dmm.ATTR_DIGI_FUNCTION, dmm.FUNC_DIGITIZE_VOLTAGE, dmm.ATTR_DIGI_COUNT, sampleCount)
---  
--- -- Set the range to 10 V.
...
--- channel.setdmm("1:2", dmm.ATTR_DIGI_LIMIT_AUTO_CLEAR_1, dmm.OFF, dmm.ATTR_DIGI_LIMIT_HIGH_1, 5, dmm.ATTR_DIGI_LIMIT_LOW_1, 3, dmm.ATTR_DIGI_LIMIT_ENABLE_1, dmm.ON)
---  
...
--- channel.setdmm("1:2", dmm.ATTR_DIGI_LIMIT_AUTO_CLEAR_2, dmm.OFF, dmm.ATTR_DIGI_LIMIT_HIGH_2, 7, dmm.ATTR_DIGI_LIMIT_LOW_2, 1, dmm.ATTR_DIGI_LIMIT_ENABLE_2, dmm.ON)
---  
--- --- Set the beeper to sound if the reading exceeds the limits for limit 2.
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41227.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- highLimit
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41229.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
--- -- Each has a sample count of 50.
--- channel.setdmm("1:2", dmm.ATTR_MEAS_FUNCTION, dmm.FUNC_DC_VOLTAGE, dmm.ATTR_MEAS_COUNT, sampleCount)
---  
--- -- Set the range to 10 V.
...
--- -- to fail if reading exceeds 5 V, set low limit to fail if
--- -- reading is less than 3 V, and enable limit checking.
--- channel.setdmm("1:2", dmm.ATTR_MEAS_LIMIT_AUTO_CLEAR_1, dmm.OFF, dmm.ATTR_MEAS_LIMIT_HIGH_1, 5, dmm.ATTR_MEAS_LIMIT_LOW_1, 3, dmm.ATTR_MEAS_LIMIT_ENABLE_1, dmm.ON)
---  
--- -- Set up limit 2: Disable auto clearing, set the high limit
--- -- to fail if reading exceeds 7 V, set low limit to fail if
--- -- reading is less than 1 V, and enable limit checking.
--- channel.setdmm("1:2", dmm.ATTR_MEAS_LIMIT_AUTO_CLEAR_2, dmm.OFF, dmm.ATTR_MEAS_LIMIT_HIGH_2, 7, dmm.ATTR_MEAS_LIMIT_LOW_2, 1, dmm.ATTR_MEAS_LIMIT_ENABLE_2, dmm.ON)
--- -- Set the beeper to sound if the reading exceeds the limits for limit 2.
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41230.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.FUNC_DC_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41246.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_DC_VOLTAGE
...
--- channel.setdmm("1", dmm.ATTR_MEAS_MATH_FORMAT, dmm.MATH_MXB, dmm.ATTR_MEAS_MATH_MXB_MF, 0.8, dmm.ATTR_MEAS_MATH_MXB_BF, 42, dmm.ATTR_MEAS_MATH_ENABLE, dmm.ON)
--- 
--- --Enables the y = mx + b math operation on digitize voltage measurements made on channel 1 of slot 1. Set the m (scale) factor to 0.8 and the b (offset) factor to 42.
--- ```
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41247.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_DC_VOLTAGE
...
--- This attribute specifies the offset (b) for an mx + b operation.The mx + b math operation lets you manipulate normal display readings (x) mathematically based on the calculation:Where:
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41252.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.digitize.func = dmm.FUNC_DIGITIZE_CURRENT
...
--- channel.setdmm("1", dmm.ATTR_DIGI_FUNCTION, dmm.FUNC_DIGITIZE_VOLTAGE)
--- -- Set channel 1 to use the MXB math format, set up the factors, and enable math.
--- channel.setdmm("1", dmm.ATTR_DIGI_MATH_FORMAT, dmm.MATH_MXB, dmm.ATTR_DIGI_MATH_MXB_MF, 0.8, dmm.ATTR_DIGI_MATH_MXB_BF, 42, dmm.ATTR_DIGI_MATH_ENABLE, dmm.ON)
--- 
--- --Enables the y = mx + b math operation on digitize voltage measurements made on channel 1 of slot 1. Set the m (scale) factor to 0.8 and the b (offset) factor to 42.
--- ```
...
--- This command sets the scale factor (m) for an mx + b operation for the selected measurement function.The mx + b math operation lets you manipulate normal display readings (x) mathematically according to the following calculation:Where: 
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41255.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.digitize.func = dmm.FUNC_DIGITIZE_CURRENT
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41394.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.digitize.func = dmm.FUNC_DIGITIZE_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/43708.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.digitize.func = dmm.FUNC_DIGITIZE_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41398.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.digitize.func = dmm.FUNC_DIGITIZE_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41406.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.digitize.func = dmm.FUNC_DIGITIZE_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41724.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.digitize.func = dmm.FUNC_DIGITIZE_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41407.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_DC_CURRENT
...
--- This is only available when the analog trigger mode is set to edge.Rising causes an analog trigger event when the analog signal trends from below the analog signal level to above the level.Falling causes an analog trigger event when the signal trends from above to below the level.
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41410.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_DC_CURRENT
...
--- This is only available when the analog trigger mode is set to window.
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/41727.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_DC_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/43709.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_DC_VOLTAGE
...
--- Only available when the analog trigger mode is set to window.The high level must be greater than the low level.To use the analog trigger with the measure functions, a range must be set (you cannot use autorange) and autozero must be disabled.
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/43710.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dmm.measure.func = dmm.FUNC_DC_VOLTAGE
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/72556.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- channel.setdmm("1:5", dmm.ATTR_MEAS_FUNCTION, dmm.FUNC_DC_VOLTAGE)
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/72561.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- channel.setdmm("1:5", dmm.ATTR_MEAS_FUNCTION, dmm.FUNC_DC_VOLTAGE)
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/13949.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/13986.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- waitcomplete()
...
--- waitcomplete()
--- 
--- --Start a trigger model or scan and wait for completion.
--- ```
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/14769.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- ```
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/15057.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/15058.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- format.asciiprecision = 10
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/17645.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- x = 10
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/29846.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- opc()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/34054.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset(true)
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/34589.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_DMM6500/89066.htm"])
---
---<br>*Examples:*<br>
--- ```lua

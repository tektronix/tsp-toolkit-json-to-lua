...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/13987.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/13988.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- for name in userstring.catalog() do
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/13989.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/13990.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- userstring.add("assetnumber", "236")
...
--- **This function returns to a previous version of the Model 2460 firmware.**
---
--- *Type:*  Function
---
--- *Details:*<br>
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/14062.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- ```
...
--- **This function upgrades the Model 2460 firmware.**
---
--- *Type:*  Function
---
--- *Details:*<br>
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/14063.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- ```
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/14073.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/14074.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/14076.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- This function retrieves the response of the remote device to *IDN?.
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/14078.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/14079.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/14080.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/14081.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- ```
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/14084.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- tspnet.timeout = 2.0
...
---
--- *Details:*<br>
--- The tspnet.write() function sends inputString to the remote instrument. It does not wait for command completion on the remote instrument.The Model 2460 sends inputString to the remote instrument exactly as indicated. The inputString must contain any necessary new lines, termination, or other syntax elements needed to complete properly.Because tspnet.write() does not process output from the remote instrument, do not send commands that generate too much output without processing the output. This command can stop executing if there is too much unprocessed output from previous commands.
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/14089.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/34363.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- deviceID = tspnet.connect("192.0.2.1")
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/14860.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- gpib.address = 26
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/25725.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/28423.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/30504.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
localnode.showevents = eventlog.SEV_ALL
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/33148.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/34629.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/40235.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/30551.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/25637.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- *TRG
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/25639.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/16856.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- test8.run()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/16863.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- test8.save()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/25630.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset() 
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/25640.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
--- This attribute contains the unit of measure that is stored with readings in the reading buffer.
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/25641.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset() 
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/25706.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset() 
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/25707.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset() 
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/25712.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/25713.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset() 
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/25715.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset() 
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/25716.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset() 
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/30485.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/30488.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/30489.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/30538.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/30542.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/30545.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset() 
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/30550.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset() 
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/30577.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset() 
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/33164.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset() 
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/34340.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset() 
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/46323.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/56793.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/56794.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- test1 = buffer.make(100)
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/81089.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/81090.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- extBuffer = buffer.make(100, buffer.STYLE_WRITABLE_FULL)
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/25635.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dataqueue.clear()
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/25636.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- dataqueue.clear()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/25723.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- file.mkdir("TestData")
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/25724.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/27929.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/27930.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/27934.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/27958.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/34905.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- local response
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/28048.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- x = 1.23
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/28056.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/28063.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- format.asciiprecision = 10
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/33286.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/33290.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/33394.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- script.delete("test8")
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/14085.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/14086.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/14090.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/32684.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
smu.measure.displaydigits = smu.DIGITS_3_5
...
triggerlanoutArr.protocol = lan.PROTOCOL_MULTICAST
...
smu.source.protect.level = smu.PROTECT_60V
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/13949.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/13986.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- waitcomplete()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/14769.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- ```
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/15057.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/15058.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- format.asciiprecision = 10
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/17645.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- x = 10
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/29846.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- opc()
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/34054.htm"])
---
---<br>*Examples:*<br>
--- ```lua
--- reset(true)
...
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/34589.htm"])
---
---<br>*Examples:*<br>
--- ```lua
...
--- 
---
---[command help](command:kic.viewHelpDocument?["Commands_2460/89066.htm"])
---
---<br>*Examples:*<br>
--- ```lua
